...
export class AboutComponent implements OnInit {
  ...
  description: string = "Algorithm: on serverside each url gets GUID(globally unique identifier) after this you can navigate through /navigate/ endpoint just with adding shortened site guid.";
  form!: FormGroup;
